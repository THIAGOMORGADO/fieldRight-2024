...
export const SuperCategorySearch: React.FC<{ navigation: any; route: IRoute }> = ({  route }) => {
...
const navigation = useNavigation()
	...
	useEffect(() => {
		...
		navigation.setOptions({
			...
			headerTitle:()=><TextInput placeholderTextColor={'white'} value={search} onChangeText={setSearch} autoFocus={true} placeholder="O que esta procurando?" style={{ width: '100%', height: 50, fontSize: 20,color: 'white' }}  />,
